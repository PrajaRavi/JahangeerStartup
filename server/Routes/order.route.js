...
import { CreateOrder, DeleteOrder, GetAllOrder, GetOrders, UpdateOrder, UpdateOrderStatus } from "../Controllers/order.controller.js";
...
OrderRouter.delete("/delete-order",protect,DeleteOrder)
